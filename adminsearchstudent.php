				...
				<div class="col-md-12">
					<div class="card">
						...
						<div class="" style="padding-left:15px; padding-bottom:20px;">
							<form method="get">
								Type in Student ID: <input type="number" name="studentid" class="form-control" required><br>
...
<?php								
							...
							<h3><?php echo "Name: ".$studentinfo['name'];?></h3>
							<h3><?php echo "Year: ".$studentinfo['year'];?></h3>  
...
<?php
if($in_nhs=='yes' and $view_society ='NHS')	{
...
<?php	
if($in_snhs=='yes' and $view_society ='SNHS')	{	
...
endwhile;
							...
							<span><?php echo $fieldinfo['subject']. ",";?></span>
				...
				$studentsql = "SELECT project_list.*, students_in_projects.*, students.* FROM project_list, students_in_projects, students WHERE students.studentid = students_in_projects.studentid AND students_in_projects.projectid = project_list.projectid AND students.studentid = '$studentid'";
				$resultsql = mysqli_query( $connection, $studentsql );
