	...
	<div class="main-panel">
		...
		<div class="content">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="header">
								<h4 class="title">Change Logged Officer Honor Society</h4>
			...
			if ( isset( $_POST[ 'change_society' ] ) & !empty( isset( $_POST[ 'change_society' ] ) ) ) {
				...
				$changehonorsql = "UPDATE students SET officer_log='$logged_honor_society' WHERE studentid = '$id'";
				$changehonorresult = mysqli_query( $connection, $changehonorsql );

				if ( $changehonorresult ) {
					//echo "everything worked successfully";
					echo '<script>window.location.href = "changeloggedofficer.php?success=success!";</script>';	

				} else {
					//echo "Error: " . $sql . "<br>" . mysqli_error($conn);
					//echo "Entry failed to be absidlkfj";
					echo '<script>window.location.href = "changeloggedofficer.php?error=Failed to change";</script>';	
				}
